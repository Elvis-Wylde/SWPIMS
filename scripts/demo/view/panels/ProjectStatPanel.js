Ext.define('RMIS.view.panels.ProjectStatPanel', {
    extend: 'RMIS.view.panels.FloatPanel',
    xtype: 'projectstatpanel',
    
    requires: [
        'Ext.layout.container.HBox',
        'RMIS.view.widgets.SumWidget',
	    'RMIS.controller.panels.ProjectStatPanelController'
    ],    
    
    controller: 'projectstatpanel',
    ...
    initStore: function() {
    	var me = this;
    	me.projectStore = RMIS.getApplication().getStore('Projects');
    },
